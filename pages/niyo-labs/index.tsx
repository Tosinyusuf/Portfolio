        ...
        <div className="about_section flex-col md:flex-row mt-[2rem] md:mt-[5rem]">
          <div className="flex-1">
            ...
            <p className="font-mainlux leading-[2rem] font-[300] text-[1rem] pt-5 w-[100%] md:w-[75%]">
              Niyo Labs is a platform focused on transforming education by
              offering tech training to individuals and organizations. It
              emphasizes collaborative and gamified learning experiences, aiming
              to equip users with skills for the digital economy. The platform
              provides a wide range of courses in areas such as data analysis,
              digital marketing, and project management. It also offers features
              like interactive quizzes, learning with peers, and access to job
              opportunities, making it ideal for career advancement
            </p>
          </div>
          <div className="flex-1">
            <p className="font-mainlux leading-[2rem] md:leading-[3rem] font-[900] text-[1.5rem] md:text-[2rem]">
