        ...
        <div className="about_section flex-col md:flex-row mt-[2rem] md:mt-[5rem]">
          <div className="flex-1">
            ...
            <p className="font-mainlux leading-[2rem] font-[300] text-[1rem] pt-5 w-[100%] md:w-[75%]">
              Clubarant is a digital menu platform that simplifies the
              management of menus for businesses, particularly in the
              hospitality industry. It enables users to easily create, upload,
              and update their menus online with a customizable and intuitive
              interface. The platform provides features such as real-time menu
              updates, multi-device compatibility, and options to add images,
              descriptions, and prices for each menu item​ . Core features of
              Clubarant include customizable templates for branding, ease of
              price management, order feature, and the ability to generate
              barcodes for customers to access the digital menu. This tool is
              aimed at enhancing customer experiences by offering a modern and
              engaging menu system
            </p>
          </div>
          <div className="flex-1">
            <p className="font-mainlux leading-[2rem] md:leading-[3rem] font-[900] text-[1.5rem] md:text-[2rem]">
            ...
            <ul className="font-mainlux leading-[2rem] font-[300] text-[1rem] pt-5 w-[100%] md:w-[75%]">
              ...
              <li>
                Mentored junior developer, conducted code reviews, and promoted best practices and code quality
              </li>
            </ul>
          </div>
