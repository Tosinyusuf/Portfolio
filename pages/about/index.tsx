        ...
        <div className="about_section flex-col md:flex-row mt-[2rem] md:mt-[5rem]">
          <div className="flex-1 md:pl-8 px-5">
            ...
            <p className="font-mainlux leading-[1.72rem] font-[300] text-[1rem] pt-5">
              My journey into software engineering began five years ago, driven
              ...
              become proficient in both front-end and back-end development,
              giving me the versatility to build end-to-end solutions.
            </p>
            <p className="font-mainlux leading-[1.72rem] font-[300] text-[1rem] pt-9">
              I’m passionate about using modern technologies to develop fast, responsive, and
              accessible user interfaces. I am equally comfortable building
              server-side logic, integrating APIs, and ensuring that my
              applications are scalable and efficient.
            </p>
